...
enum KeywordLogical { klNone = -1, klAnd = kgcAnd, klOr = kgcOr };

enum KeywordObjectInfo { koiObject = kgcObject, koiValue = kgcValue };

enum KeywordOrintation { koAsc = kgcAsc, koDesc = kgcDesc };
...
static const auto KeywordOperators = QVector<int>{koEqual,
                                                  koNotEqual,
                                                  koEqualMinor,
                                                  koEqualBigger,
                                                  koBigger,
