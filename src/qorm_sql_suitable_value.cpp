...
namespace PrivateQOrm {
    ...
    typedef QHash<QVariant::Type, QString> TypeVariantType;
...
{
    return this->toVar(v, v.type());
}

QString SqlSuitableValue::toVar(const QVariant&v, const QVariant::Type &vType)
{
    switch (vType) {
