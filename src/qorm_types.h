...
#define QORM_MODEL_DECLARE_FORM_TYPE enum FormType { UndefinedForm, ReportForm , RegisterForm, EditFields, EditAddress, EditDualList, ReportGridList }; Q_ENUM(FormType)
