...
#define QORM_MODEL_DECLARE_FORM_TYPE \
    enum FormType { \
     UndefinedForm\
    ,ReportForm\
    ,RegisterForm\
...
#define QORM_MODEL_DECLARE_FORM_ENUMS QORM_MODEL_DECLARE_FORM_TYPE QORM_MODEL_DECLARE_FORM_LAYOUT QORM_MODEL_DECLARE_FORM_ACTION_START
