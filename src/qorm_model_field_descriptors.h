...
#define QORM_DESCRIPTOR_ENDPOINT_SET(ENDPOINT) const auto ENDPOINT##EndPoint=this->addEndPoint(#ENDPOINT, ENDPOINT).uuid()
#define QORM_DESCRIPTOR_ENDPOINT_SET_OBJECT(BASENAME, ENDPOINT) const auto ENDPOINT##BASENAME##EndPoint=addEndPoint(#ENDPOINT, ENDPOINT)
#define QORM_DESCRIPTOR_ENDPOINT_ARG(ENDPOINT) const auto ENDPOINT##EndPoint=addEndPoint(#ENDPOINT, ENDPOINT)
